...
export function ReddiModal({ open, onClose, onSubmit }: ReddiModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose}>
      ...
      {/* Title */}
      <h2 className="mb-2 text-2xl font-extrabold text-foreground">Lag påstander med REDDI</h2>
      ...
      {/* Textarea */}
      <div className="mb-6">
        <label className={`mb-1.5 block ${LABEL_CLASS}`}>Hva skal påstandene handle om?</label>
        <textarea
          value={topic}
