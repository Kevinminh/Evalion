...
const options = [
  { value: "sant" as const, label: "Sant", bg: "bg-[#4CAF50]", hover: "hover:bg-[#43A047]", glow: "shadow-[0_0_20px_rgba(76,175,80,0.4)]" },
  { value: "usant" as const, label: "Usant", bg: "bg-[#EF5350]", hover: "hover:bg-[#E53935]", glow: "shadow-[0_0_20px_rgba(239,83,80,0.4)]" },
  { value: "delvis" as const, label: "Delvis sant", bg: "bg-[#FF9800]", hover: "hover:bg-[#FB8C00]", glow: "shadow-[0_0_20px_rgba(255,152,0,0.4)]" },
] as const;
